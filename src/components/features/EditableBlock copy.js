  ...
  onKeyDownHandler = (e) => {
    ...
    if (e.key === "Enter") {
      if (this.state.previousKey !== "Shift" && this.props.tag !== "code") {
        ...
        // preCaretRange.selectNodeContents(this.contentEditable.current);
        // preCaretRange.setStart(range.startContainer, range.endOffset);
        // console.log(range.endOffset, "1hjuids");
        // console.log(preCaretRange.toString(), "33333333");

        // range.selectNodeContents(this.contentEditable.current);
        // const stringLenth = range.toString().length;
        // console.log(range.toString(), stringLenth, range.endOffset,"ppppppppppppppppp");
